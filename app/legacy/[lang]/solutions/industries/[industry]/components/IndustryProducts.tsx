...
import { getAppBySlugSync } from '@/libs/legacy/config/apps';
import type { IndustryProductRef } from '@/libs/legacy/config/industries';
...
export default function IndustryProducts({ products, industryName }: IndustryProductsProps) {
		...
		<AnimateElement type='slideUp'>
			<section className='mb-20'>
				<div className='mb-12 text-center'>
					<h2 className='mb-4 text-3xl font-bold text-gray-900'>{industryName} Apps & Tools</h2>
					<p className='mx-auto max-w-3xl text-lg text-gray-600'>
						Discover powerful applications and tools designed to enhance workflows and productivity in{' '}
						{industryName.toLowerCase()} environments.
					</p>
				</div>
					...
					{appProducts.map((app, index) => (
						...
						>
							<div className='flex h-full min-h-[500px] flex-col rounded-xl border border-gray-100 bg-white p-6 shadow-md transition-all hover:-translate-y-1 hover:shadow-lg'>
								...
								<div className='mb-6'>
									<h4 className='mb-2 font-semibold text-gray-900'>Perfect for:</h4>
