...
export default function IndividualBenefits({ benefits, industryName }: IndividualBenefitsProps) {
	return (
			...
			<section className='mb-20'>
				<div className='mb-12 text-center'>
					...
					<p className='mx-auto max-w-3xl text-lg text-gray-600'>
						Sealos provides a comprehensive cloud platform specifically designed to empower individual
						professionals in the {industryName.toLowerCase()} sector, offering enterprise-grade capabilities
						at individual-friendly pricing.
					</p>
				</div>
								...
								<div className='flex items-start gap-4'>
									...
									<div className='flex flex-1 flex-col'>
										...
										<p className='flex-1 leading-relaxed text-gray-600'>
											Perfect for individual {industryName.toLowerCase()} professionals:{' '}
											{benefit.description}
										</p>
									</div>
								</div>
