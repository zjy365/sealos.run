...
import type { IndustryChallenge } from '@/libs/legacy/config/industries';
...
export default function IndividualChallenges({ challenges, industryName }: IndividualChallengesProps) {
	return (
			...
			<section className='mb-20'>
				<div className='mb-12 text-center'>
					...
					<p className='mx-auto max-w-3xl text-lg text-gray-600'>
						As an individual professional in the {industryName.toLowerCase()} sector, you face unique
						technology challenges that can limit your productivity and growth potential.
					</p>
				</div>
