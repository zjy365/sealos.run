...
import { Analytics } from '@/libs/legacy/components/analytics';
import { GTMBody } from '@/libs/legacy/components/analytics/gtm-body';
import { DefaultSearchDialog } from '@/libs/legacy/components/docs/Search';
import StructuredDataComponent from '@/libs/legacy/components/structured-data';
import { locales } from '@/libs/legacy/utils/i18n';
import { generatePageMetadata } from '@/libs/legacy/utils/metadata';
import { generateHomepageSchema } from '@/libs/legacy/utils/structured-data';
import './global.css';
...
export default async function LocaleLayout(props: { children: ReactNode; params: Promise<{ lang: string }> }) {
	...
	return (
		<html
			...
			// ! ================
			// This is important for style quarantine.
			data-version='legacy'
			// ! ================
		>
			<head>
