...
import Video from '@/libs/legacy/components/video';
import { appDomain, siteConfig } from '@/libs/legacy/config/site';
import type { languagesType } from '@/libs/legacy/utils/i18n';
import { generatePageMetadata } from '@/libs/legacy/utils/metadata';
import { generateBreadcrumbSchema, generateDevBoxSchema } from '@/libs/legacy/utils/structured-data';
