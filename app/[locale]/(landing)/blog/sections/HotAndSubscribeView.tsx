...
interface HotAndSubscribeViewProps {
	recentPosts: BlogPost[];
}

export default function HotAndSubscribeView({ recentPosts }: HotAndSubscribeViewProps) {
	const t = useTranslations('pages.blog.sections.hotAndSubscribe');
	return (
