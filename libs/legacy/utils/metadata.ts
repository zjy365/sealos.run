import { blogAuthors, domain, siteConfig } from '@/libs/legacy/config/site';
...
export async function generateDocsMetadata(props: { params: Promise<{ lang: string; slug?: string[] }> }) {
	const params = await props.params;
